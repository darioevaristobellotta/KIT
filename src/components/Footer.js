    ...
    <footer className="site-footer">
      <div className="container footer-container">
        <div className="social-icons">
          {/* Instagram */}
          <a href="https://www.instagram.com/darioevaristobellotta" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Instagram">
          ...
          {/* YouTube */}
          <a href="https://www.youtube.com/@DarioEvaristoBellotta" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="YouTube">
            <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
          ...
          {/* LinkedIn */}
          <a href="https://www.linkedin.com/in/dario-evaristo-bellotta-a5a6361b0/" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="LinkedIn">
            <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
